...
if __name__ == "__main__":
    ...
    parser.add_argument("--src", default="car_images/Coburg2_left/1.jpg", help="path for the object image")
    parser.add_argument("--dest", default="car_images/Coburg2_front/1.jpg", help="path for image containing the object")
